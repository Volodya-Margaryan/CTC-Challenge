...
export interface RestaurantVisits {
  restaurantId: number;
  totalSpent: number;
  visits: Visit[];
}

// Visits for one restaurant, plus the total spent there.
export async function getRestaurantVisits(id: number | string): Promise<RestaurantVisits> {
